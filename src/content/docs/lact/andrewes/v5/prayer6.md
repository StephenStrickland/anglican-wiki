...
Deprecation is, when we desire that evil be removed, which kind of prayer is d\_hsij and *Techinah*.

Comprecation, is when we would have our want supplied with goods things, which is proseuc\_ and *Tephillah*.
