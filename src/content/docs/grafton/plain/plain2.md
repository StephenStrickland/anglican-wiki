...
In many churches where the chancels are dark the priests labours will be greatly relieved and accidents to the sacrament be averted by placing lights upon the altar. The primitive custom is, however, so associated with the original institution, by our Blessed Lord, of the Holy Supper deep in the night, when lights are required, that their use has a most commemorative significance.
